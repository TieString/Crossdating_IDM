                                ...
                                <>
                                    {!shouldShowRightSkeleton ? (
                                        <div className={style["cofecha-toolbar"]}>
                                            ...
                                            <CofechaUndatedControls compact fileName={cofechaUndatedFileName}
                                                sort={cofechaUndatedSort} disabled={!fileName || isCofechaRunning}
                                                onLoad={handleLoadCofechaUndated} onClear={handleClearCofechaUndated}
